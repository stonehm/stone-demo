...
public class HttpClientFactoryBean implements FactoryBean<CloseableHttpClient>, InitializingBean, DisposableBean {
    ...
    @Autowired
    public HttpClientFactoryBean(HttpClientConfig httpClientConfig) {
        this.connectionKeepAliveStrategy = httpClientConfig.connectionKeepAliveStrategy();
        this.poolingHttpClientConnectionManager = httpClientConfig.poolingHttpClientConnectionManager();
